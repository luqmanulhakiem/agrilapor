...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        @if (Request::is('lubang-tanam/rekap-bulanan/*'))
      ...
      <ol class="breadcrumb">
        @if (Request::is('lubang-tanam/rekap-bulanan/*'))
          <a  
          onclick="this.href='/lubang-tanam/download-bulanan/' + document.getElementById('bulan').value + 
        ...
        @else
          <a  
          onclick="this.href='/lubang-tanam/download-harian/'+ document.getElementById('tanggal').value; this.target='_blank'" 
          class="btn btn-success"><i class="fa fa-plus"></i> 
            Download Laporan
          </a>
        @endif
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <div class="row">
                @if (Request::is('lubang-tanam/rekap-harian/*'))
                  <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                          ...
                          <a href="" onclick="this.href='/lubang-tanam/rekap-harian/'+ document.getElementById('tanggal').value " 
                ...
                @if (Request::is('lubang-tanam/rekap-bulanan/*'))
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      <label for="">Lihat</label>
                      <a onclick="this.href='/lubang-tanam/rekap-bulanan/'+ document.getElementById('bulan').value + 
