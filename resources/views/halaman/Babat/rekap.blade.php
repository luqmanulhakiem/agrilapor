...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        @if (Request::is('babat/rekap-bulanan/*'))
          Rekap Bulanan Data Babat
        @else
          Rekap Harian Data Babat
        @endif
      </h1>
      <br>
      <ol class="breadcrumb">
        @if (Request::is('babat/rekap-bulanan/*'))
          <a  
          onclick="this.href='/babat/download-bulanan/' + document.getElementById('bulan').value + 
        ...
        @else
          <a  
          onclick="this.href='/babat/download-harian/'+ document.getElementById('tanggal').value; this.target='_blank'" 
          class="btn btn-success"><i class="fa fa-plus"></i> 
            Download Laporan
          </a>
        @endif
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <div class="row">
                @if (Request::is('babat/rekap-harian/*'))
                  <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                          ...
                          <a href="" onclick="this.href='/babat/rekap-harian/'+ document.getElementById('tanggal').value " 
                ...
                @if (Request::is('babat/rekap-bulanan/*'))
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      <label for="">Lihat</label>
                      <a onclick="this.href='/babat/rekap-bulanan/'+ document.getElementById('bulan').value + 
